...
var zh2 = {
  ...
  "pinOffDisclaimerTitle": "\u{1F513} \u5F00\u542F\u5C40\u57DF\u7F51\u514D\u5BC6\u6A21\u5F0F",
...
var en2 = {
  ...
  "pinOffDisclaimerTitle": "\u{1F513} Enable passwordless LAN",
  ...
  return (0, import_react2.createElement)(
    ...
    (0, import_react2.createElement)(
      ...
      status?.lanEnabled === false ? (0, import_react2.createElement)("div", { style: { marginTop: 8, fontSize: 12, color: "var(--dsw-alias-state-warn-primary,#b45309)", lineHeight: 1.5 } }, t("lanDisabledHint")) : lanUrl ? (0, import_react2.createElement)(
        ...
        row(
          t("lanPin"),
          Switch(status?.lanAuthEnabled !== false, () => requestLanAuth(status?.lanAuthEnabled === false)),
    ...
    disclaimerMode ? (0, import_react2.createElement)(
      ...
      (0, import_react2.createElement)(
        "div",
        { style: { background: "var(--dsw-alias-bg-layer-1,#fff)", borderRadius: 12, maxWidth: 420, width: "100%", padding: "20px 22px", boxShadow: "0 8px 32px rgba(0,0,0,.18)" } },
        (0, import_react2.createElement)("div", { style: { fontWeight: 600, fontSize: 15, color: "var(--dsw-alias-state-warn-primary,#b45309)", marginBottom: 10 } }, t(disclaimerMode === "lan" ? "lanDisclaimerTitle" : disclaimerMode === "named" ? "namedDisclaimerTitle" : disclaimerMode === "lan-pin-off" ? "pinOffDisclaimerTitle" : "quickDisclaimerTitle")),
        (0, import_react2.createElement)("div", { style: { fontSize: 13, lineHeight: 1.7, color: "var(--dsw-alias-label-primary,inherit)", whiteSpace: "pre-line" } }, t(disclaimerMode === "lan" ? "lanDisclaimerBody" : disclaimerMode === "named" ? "namedDisclaimerBody" : disclaimerMode === "lan-pin-off" ? "pinOffDisclaimerBody" : "quickDisclaimerBody")),
        (0, import_react2.createElement)(
          "label",
